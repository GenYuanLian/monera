...
@LoginCheck
@Component("hapiloginOutprocessor")
public class LoginOutProcessor extends BaseApiProcessor {
	@Resource
	...
	protected void process(HttpServletRequest request, HttpServletResponse response, ResultSender sender)
		...
		ShopMessageVo<Map<String, Object>> messageVo = memberApi.loginOut(params);
