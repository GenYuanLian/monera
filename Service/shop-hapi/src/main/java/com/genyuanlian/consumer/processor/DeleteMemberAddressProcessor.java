...
@LoginCheck
@Component("hapideleteMemberAddressprocessor")
public class DeleteMemberAddressProcessor extends BaseApiProcessor {
	@Resource
	...
	protected void process(HttpServletRequest request, HttpServletResponse response, ResultSender sender)
		...
		ShopMessageVo<Map<String, Object>> messageVo = memberApi.deleteMemberAddress(params);
