...
@LoginCheck
@Component("hapigetMemberAddressprocessor")
public class GetMemberAddressProcessor extends BaseApiProcessor {
	@Resource
	...
	protected void process(HttpServletRequest request, HttpServletResponse response, ResultSender sender)
		...
		params.setId(Long.parseLong(addressId));
		ShopMessageVo<Map<String, Object>> messageVo = memberApi.getMemberAddress(params);
		if (messageVo.isResult()) {
			sender.put("addr", messageVo.getT().get("addr"));
			sender.put("areas", messageVo.getT().get("areas"));
